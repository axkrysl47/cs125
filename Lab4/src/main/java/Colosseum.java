...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        int points = 50;
        boolean validAttackLevel = false;
        System.out.print("Enter your attack level (1-49): ");
        while (validAttackLevel == false) {
            ...
            if (attackLevel > 49 || attackLevel < 1) {
                ...
                validAttackLevel = true;
            }
        }

        boolean validDefenseLevel = false;
        System.out.print("Enter your attack level (1-" + points  + "): ");
        while (validDefenseLevel == false) {
            int defenseLevel = input.nextInt();
            if (defenseLevel > points || defenseLevel < 1) {
                System.out.print("Sorry. The defense level must be between 1 and 49: ");
            } else {
                tempPokemon.defenseLevel = defenseLevel;
                validDefenseLevel = true;
            }
        }
